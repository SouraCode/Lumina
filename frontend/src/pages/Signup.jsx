  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh]">
      <div className="w-full max-w-md p-8 bg-neutral-900 border border-neutral-800 rounded-2xl shadow-xl">
        <h2 className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-primary-500 to-fuchsia-500 bg-clip-text text-transparent">Create Account</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input type="text" required className="block w-full pl-10 pr-3 py-2 border border-neutral-700 rounded-lg bg-black text-white focus:ring-2 focus:ring-primary-500 outline-none" placeholder="John Doe" value={name} onChange={(e) => setName(e.target.value)} />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="password" required minLength="6" className="block w-full pl-10 pr-3 py-2 border border-neutral-700 rounded-lg bg-black text-white focus:ring-2 focus:ring-primary-500 outline-none" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} />
            </div>
          </div>
